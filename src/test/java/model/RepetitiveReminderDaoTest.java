...
public class RepetitiveReminderDaoTest{
    ...
    public void getBetweenTest_forTwoDaysInterval_entryNotFinished(){
        ...
        RepetitiveReminderModel model = (RepetitiveReminderModel) dao.getBetween(t1, t2).get(0);
        ArrayList<LocalDateTime> result = model.getBetween(t1, t2);
        assertEquals(3, result.size());
        assertEquals(startedAt, result.get(0));
    }
    ...
    public void getBetweenTest_forTwoDaysInterval_entryFinished(){
        ...
        assertEquals(startedAt, result.get(0));
        assertEquals(finishedAt, result.get(3));
    }
    ...
    public void getBetweenTest_forYearlyInterval(){
        ...
        assertEquals(startedAt.plusYears(1), result.get(0));
    }
}